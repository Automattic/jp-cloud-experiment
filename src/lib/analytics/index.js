/**
 * Analytics package extracted from Jetpack.
 *
 * @link https://github.com/Automattic/jetpack/tree/master/_inc/client/lib/analytics
 */
...
const debug = debugFactory( 'jpc:analytics' );
...
const analytics = {
	initialize( userId, username, superProps ) {
	...
	purchase: {
		record( transactionId, itemName, itemId, revenue, price, qty, currency ) {
	...
	ga: {
		...
		recordPurchase( transactionId, itemName, itemId, revenue, price, qty, currency ) {
